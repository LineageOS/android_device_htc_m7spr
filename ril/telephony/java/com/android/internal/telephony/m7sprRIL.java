...
/**
 * RIL customization for One M7
 *
 * {@hide}
 */
public class m7sprRIL extends RIL {

    private boolean mIsGsm = false;

    public m7sprRIL(Context context, int networkMode, int cdmaSubscription) {
        super(context, networkMode, cdmaSubscription, null);
    }

    public m7sprRIL(Context context, int preferredNetworkType,
